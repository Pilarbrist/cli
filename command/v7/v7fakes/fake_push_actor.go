...
type FakePushActor struct {
	...
	ConceptualizeStub        func(v7pushaction.CommandLineSettings, string) ([]v7pushaction.PushState, v7pushaction.Warnings, error)
...
func (fake *FakePushActor) Conceptualize(arg1 v7pushaction.CommandLineSettings, arg2 string) ([]v7pushaction.PushState, v7pushaction.Warnings, error) {
...
func (fake *FakePushActor) ConceptualizeCalls(stub func(v7pushaction.CommandLineSettings, string) ([]v7pushaction.PushState, v7pushaction.Warnings, error)) {
	fake.conceptualizeMutex.Lock()
	defer fake.conceptualizeMutex.Unlock()
	fake.ConceptualizeStub = stub
}

func (fake *FakePushActor) ConceptualizeArgsForCall(i int) (v7pushaction.CommandLineSettings, string) {
	fake.conceptualizeMutex.RLock()
	defer fake.conceptualizeMutex.RUnlock()
