...
func getTestPushActor() (*Actor, *v7pushactionfakes.FakeV2Actor, *v7pushactionfakes.FakeV3Actor, *v7pushactionfakes.FakeSharedActor) {
	fakeV2Actor := new(v7pushactionfakes.FakeV2Actor)
	fakeV3Actor := new(v7pushactionfakes.FakeV3Actor)
